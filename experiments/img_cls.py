...
if __name__ == '__main__':
    ...
    pretrain_folder = [
        ...
        # "vikl_manineg_short_pt_fixed_imnet"
        # "new_vikl_pt_fdebug2_t0.7_imnet_fixed"
        # "vikl_manineg_long_pt_imnet"
        # "vikl_manineg_ms_pt_imnet",
        # "vikl_manineg_emm_ms_t1.0_pt_imnet",
        # "vikl_manineg_emm_ms_t0.8_pt_imnet"
        # "baseline_woh_II_ms_pt_imnet",
        # "baseline_woh_II_ms_tt_pt_imnet",
        # "baseline_woh_IM_ms_pt_imnet",
        # "baseline_woh_IM_ms_tt_pt_imnet",
        "baseline_hrw_IM_ms_pt_t0.03_imnet",
        "manineg_II_tt_emm3_ms_pt_imnet",
        "manineg_IM_tt_emm3_ms_pt_imnet",
    ]
    dataset = "inbreast"
    for p in pretrain_folder:
        ...
        for i in range(10):
            trainer = Trainer(
                tag=f"{p}_{dataset}_{'l_eval' if config['l_eval'] else 'ft'}_{i}",
                **config)
            # noes: no early stop
            # ps: padding square
            trainer.main()
