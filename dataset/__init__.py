...
def create_dataset(dataset, config):
    # FIXME: normalize有两种，一是按照类似ImageNet的normalize，二是实际计算的normalize。ViKL均使用ImageNet Normalize
    # [12/08 03:30:08:INFO:None_hmbm_renormalize_l_eval_0]
    # Testing: {'spe': '0.37975', 'sen': '0.83073', 'auc': '0.69927', 'f1': '0.79650', 'acc': '0.69926'}
    # 实验似乎证明实际的normalize没有什么额外的优势，故仍然可以保持使用ImageNet normalize
    # [12 / 08 03: 43:39: INFO:clip_hmbm_ft_nobbr_0]
    # Testing: {'spe': '0.36709', 'sen': '0.82292', 'auc': '0.70171', 'f1': '0.79000', 'acc': '0.69004'}
    # normalize ImageNet
    ...
    # normalize HMBM实际
    # normalize = transforms.Normalize(
    #     (0.12705863, 0.12705863, 0.12705863),
    #     (0.22428249, 0.22428249, 0.22428249)
    # )
    # 数据增强方式
    # 1. 预训练数据增强
